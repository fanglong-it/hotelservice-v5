...
public class ServiceServiceImpl implements ServiceService {
    ...
    public List<Service> getAllServicesByServiceCategory(long id) {
        ...
        // List<Image> images = imageRepository.getAllByPictureType("img_service_" +
        // service.getId());
    ...
    @Override
    public Service updateService(fiveman.hotelservice.entities.Service service) {
    ...
    @Override
    public Service saveServices(fiveman.hotelservice.entities.Service service) {
        if (!serviceRepository.existsById(service.getId())) {
            service.setServiceCategory(
                    serviceCategoryRepository.getServiceCategoryById(service.getServiceCategory().getId()));
            service.setCreateDate(Utilities.getCurrentDateByFormat("dd/MM/yyyy"));
            serviceRepository.save(service);
            return serviceRepository.findTopByOrderByIdDesc();
        }
