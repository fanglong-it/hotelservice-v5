...
public interface RoomRepository extends JpaRepository<Room, Long> {
    ...
    @Query(value = "select r.id, r.create_by, r.create_date, r.description, r.last_modify_by, r.name, r.room_no, r.status, r.update_date, r.hotel_id, r.room_type_id from room r inner join booking b on r.id = b.room_id where b.id = :booking_id and b.status = 'CHECK IN'", nativeQuery = true)
    Room getRoomByBookingAndStatusCheckIn(long booking_id);
    ...
    @Query(value = "select r.id, r.create_by, r.description, r.last_modify_by, r.name, r.room_no, r.status,r.create_date ,r.update_date, r.hotel_id, r.room_type_id from room r inner join booking b on r.id = b.room_id inner join orders ord on ord.booking_id = b.id where ord.id = :order_id", nativeQuery = true)
