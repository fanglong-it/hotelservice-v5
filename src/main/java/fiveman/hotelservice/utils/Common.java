...
public class Common {
    ...
    //Defaut value for News
    public static final String NEW_DELETE = "DELETED";
    ...
    public static final String BOOKING_REQUEST_CANCLE = "REQUEST CANCEL";
    ...
    // "http://localhost:3000/bookingConfirm";
